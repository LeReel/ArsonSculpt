...
void AS_Camera::ProcessKeyboard(Camera_Movement direction, float deltaTime)
{
...
void AS_Camera::ProcessMouseMovement(float xoffset, float yoffset, bool constrainPitch)
{
...
void AS_Camera::UpdateCameraVectors()
{
